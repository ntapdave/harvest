...
public class apitest {
    ...
    public static void usage() {
        ...
        System.out.println("\tUse server type 'dfm' (-t dfm) for Active IQ Unified Manager (formerly OnCommand Unified Manager) server version 5.2 or earlier.");
        System.out.println("\tUse server type 'ocum' (-t ocum) for Active IQ Unified Manager (formerly OnCommand Unified Manager) server version 6.0 or later.\n\n");
    ...
    public static void main(String[] args) {
        ...
        if ((dodfm || doocum) && dovfiler) {
            System.out.println("The -v option is not a valid option for Active IQ Unified Manager (formerly OnCommand Unified Manager) server.\n");
            System.exit(1);
        }
        if ((dodfm || doocum) && dorpc) {
            System.out.println("The -r option is not a vaid option for Active IQ Unified Manager (formerly OnCommand Unified Manager) server.\n");
            System.exit(1);
        }
        if (host_equiv && dorpc) {
