...
sub print_usage() {
	...
	print "Note: \n";
	print "     Use server type 'dfm' (-t dfm) for Active IQ Unified Manager (formerly OnCommand Unified Manager) server version 5.2 or earlier.\n";
	print "     Use server type 'ocum' (-t ocum) for Active IQ Unified Manager (formerly OnCommand Unified Manager) server version 6.0 or later.\n\n";
...
if (($dodfm || $doocum) && $dovfiler) {
	print "The -v option is not a valid option for Active IQ Unified Manager (formerly OnCommand Unified Manager) server.\n";
	exit 2;
}

if (($dodfm || $doocum) && $send_oid) {
	print "The -o option is not a valid option for Active IQ Unified Manager (formerly OnCommand Unified Manager) server.\n";
	exit 2;
}
