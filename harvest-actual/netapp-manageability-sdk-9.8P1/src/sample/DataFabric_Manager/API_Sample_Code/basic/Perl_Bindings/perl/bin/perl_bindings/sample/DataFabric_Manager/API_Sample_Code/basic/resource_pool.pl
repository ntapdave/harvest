#========================================================================#
#                                                                        #
# $Id: //depot/prod/zephyr/R9.8P1/src/perl/bin/perl_bindings/sample/DataFabric_Manager/API_Sample_Code/basic/resource_pool.pl#1 $                                                                   #
#                                                                        #
# resource_pool.pl                                                       #
#                                                                        #
...
# on a Active IQ Unified Manager (formerly OnCommand Unified Manager)    #
# Core Package (5.2 or earlier)                                          #
# server. You can create,list and delete resource pools                  #
# add,list and remove members                                            #
#                                                                        #
# This Sample code is supported on Active IQ Unified Manager             #
#(formerly OnCommand Unified Manager) 5.2                                #
...
# Active IQ Unified Manager (formerly OnCommand Unified Manager) Core    #
#package(previouly DataFabric Manager).                                  #
#========================================================================#
