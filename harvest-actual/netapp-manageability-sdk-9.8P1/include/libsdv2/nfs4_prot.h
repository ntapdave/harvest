...
#define MAX_SDV2_VOLNAME_LEN 255
#define MAX_SDV2_SNAPNAME_LEN 256
#define MAX_SDV2_FILE_AC_PROTO_LEN 5
#define SPINNP_DP_BLOCK_SIZE 4096
#define SPINNP_DP_ARRAY_MAX 128
#define MAX_SDV2_RESTART_COOKIE_LEN 8191
...
enum nfsstat4 {
	...
	NFS4ERR_COMMERROR = 50088,
	NFS4ERR_MAX_SD_SESSIONS = 50089,
	NFS4ERR_SD_SESSION_ABORTED = 50090,
	NFS4_SD_SESSION_V2_OK = 50091,
	NFS4ERR_SD_SESSION_RETRY = 50092,
};
...
typedef bool_t fattr4_space_reserve;

typedef bool_t fattr4_space_freed;
/*
 * REQUIRED Attributes
 */
...
#define FATTR4_SPACE_RESERVE 77
...
struct COPY_NOTIFY4res {
	nfsstat4 cnr_status;
	union {
		COPY_NOTIFY4resok cnr_resok;
	} COPY_NOTIFY4res_u;
};
typedef struct COPY_NOTIFY4res COPY_NOTIFY4res;

struct COPY_REVOKE4args {
	netloc4 cra_dest_server;
};
typedef struct COPY_REVOKE4args COPY_REVOKE4args;

struct COPY_REVOKE4res {
	nfsstat4 crr_status;
};
typedef struct COPY_REVOKE4res COPY_REVOKE4res;
...
struct COPY4res {
	...
	union {
		struct {
			u_int cr_callback_id_len;
			stateid4 *cr_callback_id_val;
		} cr_callback_id;
...
struct COPY_ABORT4args {
	stateid4 caa_state_id;
};
typedef struct COPY_ABORT4args COPY_ABORT4args;

struct COPY_ABORT4res {
	nfsstat4 car_status;
};
typedef struct COPY_ABORT4res COPY_ABORT4res;

struct COPY_STATUS4args {
	stateid4 csa_stateid;
};
typedef struct COPY_STATUS4args COPY_STATUS4args;

struct COPY_STATUS4resok {
	length4 csr_bytes_copied;
	struct {
		u_int csr_complete_len;
		nfsstat4 *csr_complete_val;
	} csr_complete;
};
typedef struct COPY_STATUS4resok COPY_STATUS4resok;

struct COPY_STATUS4res {
	nfsstat4 cr_status;
	union {
		COPY_STATUS4resok csr_resok;
	} COPY_STATUS4res_u;
};
typedef struct COPY_STATUS4res COPY_STATUS4res;

struct SD_START4args {
	...
	struct {
		u_int file_access_proto_len;
		char *file_access_proto_val;
	} file_access_proto;
	bool_t atime;
	bool_t include_file_attr;
	bool_t checkpointing;
	bool_t include_i2p;
	uint32_t max_diffs;
	struct {
		u_int restart_cookie_len;
		char *restart_cookie_val;
	} restart_cookie;
};
typedef struct SD_START4args SD_START4args;

struct SD_START4resok {
	char *session_handle;
	char *session_id;
	char *session_status;
};
typedef struct SD_START4resok SD_START4resok;

struct SD_START4res {
	nfsstat4 status;
	union {
		SD_START4resok sd_start_resok;
		char *session_error;
	} SD_START4res_u;
};
typedef struct SD_START4res SD_START4res;

struct SD_NEXT4args {
	struct {
		u_int session_handle_len;
		char *session_handle_val;
	} session_handle;
	struct {
...
typedef struct SD_NEXT4args SD_NEXT4args;

struct spinnp_snapdiff_change_rec_V1 {
	uint32_t scr_inode_num;
	uint32_t scr_change_type;
	uint32_t scr_ftype;
	int64_t scr_crtime;
	int64_t scr_mtime;
	int64_t scr_atime;
	...
	uint32_t scr_group;
	uint32_t scr_fattr;
	uint32_t scr_dos_bits;
	uint64_t scr_size;
	uint32_t scr_links;
	uint32_t scr_is_iofenced;
	struct {
		u_int scr_name_len;
		char *scr_name_val;
	} scr_name;
};
typedef struct spinnp_snapdiff_change_rec_V1 spinnp_snapdiff_change_rec_V1;


struct spinnp_snapdiff_change_rec_V2 {
	uint64_t scr_inode_num;
	uint32_t scr_change_type;
	uint32_t scr_ftype;
	int64_t scr_crtime;
	int64_t scr_mtime;
...
typedef struct spinnp_snapdiff_change_rec_V2 spinnp_snapdiff_change_rec_V2;


struct SD_NEXT4resok_V1 {
	uint32_t num_changes;
	uint32_t progress;
	bool_t eof;
	struct {
		u_int crp_len;
		struct spinnp_snapdiff_change_rec_V1 *crp_val;
	} crp;
	struct {
		u_int restart_cookie_len;
		char *restart_cookie_val;
...
typedef struct SD_NEXT4resok_V1 SD_NEXT4resok_V1;

struct SD_NEXT4resok_V2 {
	uint32_t num_changes;
	uint32_t progress;
	bool_t eof;
	struct {
		u_int crp_len;
		struct spinnp_snapdiff_change_rec_V2 *crp_val;
	} crp;
	struct {
		u_int restart_cookie_len;
		char *restart_cookie_val;
...
typedef struct SD_NEXT4resok_V2 SD_NEXT4resok_V2;

struct SD_NEXT4res {
	nfsstat4 status;
	union {
		SD_NEXT4resok_V1 sd_next_resok_V1;
		SD_NEXT4resok_V2 sd_next_resok_V2;
		char *session_error;
	} SD_NEXT4res_u;
};
typedef struct SD_NEXT4res SD_NEXT4res;

struct SD_STATUS4args {
	struct {
		u_int session_handle_len;
		char *session_handle_val;
	} session_handle;
...
typedef struct SD_STATUS4args SD_STATUS4args;

struct SD_STATUS4resok {
	char *session_status;
};
typedef struct SD_STATUS4resok SD_STATUS4resok;

struct SD_STATUS4res {
	nfsstat4 status;
	union {
		SD_STATUS4resok sd_status_resok;
		char *session_error;
	} SD_STATUS4res_u;
};
typedef struct SD_STATUS4res SD_STATUS4res;
...
typedef struct SD_END4args SD_END4args;

struct SD_END4resok {
	char *session_status;
};
typedef struct SD_END4resok SD_END4resok;

struct SD_END4res {
	nfsstat4 status;
	union {
		SD_END4resok sd_end_resok;
		char *session_error;
	} SD_END4res_u;
};
typedef struct SD_END4res SD_END4res;

struct SD_DISCONNECT4resok {
	char *session_status;
};
typedef struct SD_DISCONNECT4resok SD_DISCONNECT4resok;

struct SD_DISCONNECT4res {
	nfsstat4 status;
	union {
		SD_DISCONNECT4resok sd_disconnect_resok;
		char *session_error;
	} SD_DISCONNECT4res_u;
};
typedef struct SD_DISCONNECT4res SD_DISCONNECT4res;

/* new operations for NFSv4.1 */


/* new operations for SDv2 */
...
struct nfs_argop4 {
	...
	union {
		...
		COPY_REVOKE4args opcopy_revoke;
		COPY4args opcopy;
		COPY_ABORT4args opcopy_abort;
		COPY_STATUS4args opcopy_status;
		SD_START4args opsd_start;
		SD_STATUS4args opsd_status;
		SD_NEXT4args opsd_next;
		SD_END4args opsd_end;
	} nfs_argop4_u;
};
...
struct nfs_resop4 {
	...
	union {
		...
		COPY_REVOKE4res opcopy_revoke;
		COPY4res opcopy;
		COPY_ABORT4res opcopy_abort;
		COPY_STATUS4res opcopy_status;
		SD_START4res opsd_start;
		SD_STATUS4res opsd_status;
		SD_NEXT4res opsd_next;
		SD_END4res opsd_end;
...
typedef struct copy_info4 copy_info4;
...
typedef struct CB_COPY4args CB_COPY4args;

struct CB_COPY4res {
	nfsstat4 ccr_status;
};
typedef struct CB_COPY4res CB_COPY4res;
...
#define NPS_PROGRAM 400010
#define NPS_V1 1

#if defined(__STDC__) || defined(__cplusplus)
#define NPSPROC_NULL 0
extern  enum clnt_stat npsproc_null_1(void *, void *, CLIENT *);
extern  bool_t npsproc_null_1_svc(void *, void *, struct svc_req *);
#define NPSPROC_COMPOUND 1
extern  enum clnt_stat npsproc_compound_1(COMPOUND4args *, COMPOUND4res *, CLIENT *);
extern  bool_t npsproc_compound_1_svc(COMPOUND4args *, COMPOUND4res *, struct svc_req *);
extern int nps_program_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define NPSPROC_NULL 0
extern  enum clnt_stat npsproc_null_1();
extern  bool_t npsproc_null_1_svc();
#define NPSPROC_COMPOUND 1
extern  enum clnt_stat npsproc_compound_1();
extern  bool_t npsproc_compound_1_svc();
extern int nps_program_1_freeresult ();
#endif /* K&R C */
...
#if defined(__STDC__) || defined(__cplusplus)
#define NFS4_CB_NULL 0
extern  enum clnt_stat nfs4_cb_null_1(void *, void *, CLIENT *);
extern  bool_t nfs4_cb_null_1_svc(void *, void *, struct svc_req *);
#define NFS4_CB_COMPOUND 1
extern  enum clnt_stat nfs4_cb_compound_1(CB_COMPOUND4args *, CB_COMPOUND4res *, CLIENT *);
extern  bool_t nfs4_cb_compound_1_svc(CB_COMPOUND4args *, CB_COMPOUND4res *, struct svc_req *);
extern int nfs4_callback_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define NFS4_CB_NULL 0
extern  enum clnt_stat nfs4_cb_null_1();
extern  bool_t nfs4_cb_null_1_svc();
#define NFS4_CB_COMPOUND 1
extern  enum clnt_stat nfs4_cb_compound_1();
extern  bool_t nfs4_cb_compound_1_svc();
extern int nfs4_callback_1_freeresult ();
#endif /* K&R C */

#define NPS_CALLBACK 0x40000100
#define NPS_CB_V1 1

#if defined(__STDC__) || defined(__cplusplus)
#define NPS_CB_NULL 0
extern  enum clnt_stat nps_cb_null_1(void *, void *, CLIENT *);
extern  bool_t nps_cb_null_1_svc(void *, void *, struct svc_req *);
#define NPS_CB_COMPOUND 1
extern  enum clnt_stat nps_cb_compound_1(CB_COMPOUND4args *, CB_COMPOUND4res *, CLIENT *);
extern  bool_t nps_cb_compound_1_svc(CB_COMPOUND4args *, CB_COMPOUND4res *, struct svc_req *);
extern int nps_callback_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define NPS_CB_NULL 0
extern  enum clnt_stat nps_cb_null_1();
extern  bool_t nps_cb_null_1_svc();
#define NPS_CB_COMPOUND 1
extern  enum clnt_stat nps_cb_compound_1();
extern  bool_t nps_cb_compound_1_svc();
extern int nps_callback_1_freeresult ();
#endif /* K&R C */
...
extern  bool_t xdr_fattr4_space_reserve (XDR *, fattr4_space_reserve*);
...
extern  bool_t xdr_COPY_REVOKE4args (XDR *, COPY_REVOKE4args*);
extern  bool_t xdr_COPY_REVOKE4res (XDR *, COPY_REVOKE4res*);
extern  bool_t xdr_COPY4args (XDR *, COPY4args*);
extern  bool_t xdr_COPY4res (XDR *, COPY4res*);
extern  bool_t xdr_COPY_ABORT4args (XDR *, COPY_ABORT4args*);
extern  bool_t xdr_COPY_ABORT4res (XDR *, COPY_ABORT4res*);
extern  bool_t xdr_COPY_STATUS4args (XDR *, COPY_STATUS4args*);
extern  bool_t xdr_COPY_STATUS4resok (XDR *, COPY_STATUS4resok*);
extern  bool_t xdr_COPY_STATUS4res (XDR *, COPY_STATUS4res*);
extern  bool_t xdr_SD_START4args (XDR *, SD_START4args*);
extern  bool_t xdr_SD_START4resok (XDR *, SD_START4resok*);
extern  bool_t xdr_SD_START4res (XDR *, SD_START4res*);
extern  bool_t xdr_SD_NEXT4args (XDR *, SD_NEXT4args*);
extern  bool_t xdr_spinnp_snapdiff_change_rec_V1 (XDR *, spinnp_snapdiff_change_rec_V1*);
extern  bool_t xdr_spinnp_snapdiff_change_rec_V1 (XDR *, spinnp_snapdiff_change_rec_V1*);
extern  bool_t xdr_spinnp_snapdiff_change_rec_V2 (XDR *, spinnp_snapdiff_change_rec_V2*);
extern  bool_t xdr_spinnp_snapdiff_change_rec_V2 (XDR *, spinnp_snapdiff_change_rec_V2*);
extern  bool_t xdr_SD_NEXT4resok_V1 (XDR *, SD_NEXT4resok_V1*);
extern  bool_t xdr_SD_NEXT4resok_V2 (XDR *, SD_NEXT4resok_V2*);
extern  bool_t xdr_SD_NEXT4res (XDR *, SD_NEXT4res*);
extern  bool_t xdr_SD_STATUS4args (XDR *, SD_STATUS4args*);
extern  bool_t xdr_SD_STATUS4resok (XDR *, SD_STATUS4resok*);
extern  bool_t xdr_SD_STATUS4res (XDR *, SD_STATUS4res*);
extern  bool_t xdr_SD_END4args (XDR *, SD_END4args*);
extern  bool_t xdr_SD_END4resok (XDR *, SD_END4resok*);
extern  bool_t xdr_SD_END4res (XDR *, SD_END4res*);
extern  bool_t xdr_SD_DISCONNECT4resok (XDR *, SD_DISCONNECT4resok*);
extern  bool_t xdr_SD_DISCONNECT4res (XDR *, SD_DISCONNECT4res*);
...
extern  bool_t xdr_copy_info4 (XDR *, copy_info4*);
extern  bool_t xdr_CB_COPY4args (XDR *, CB_COPY4args*);
extern  bool_t xdr_CB_COPY4res (XDR *, CB_COPY4res*);
...
extern bool_t xdr_fattr4_space_reserve ();
...
extern bool_t xdr_COPY_REVOKE4args ();
extern bool_t xdr_COPY_REVOKE4res ();
extern bool_t xdr_COPY4args ();
extern bool_t xdr_COPY4res ();
extern bool_t xdr_COPY_ABORT4args ();
extern bool_t xdr_COPY_ABORT4res ();
extern bool_t xdr_COPY_STATUS4args ();
extern bool_t xdr_COPY_STATUS4resok ();
extern bool_t xdr_COPY_STATUS4res ();
extern bool_t xdr_SD_START4args ();
extern bool_t xdr_SD_START4resok ();
extern bool_t xdr_SD_START4res ();
extern bool_t xdr_SD_NEXT4args ();
extern bool_t xdr_spinnp_snapdiff_change_rec_V1 ();
extern bool_t xdr_spinnp_snapdiff_change_rec_V1 ();
extern bool_t xdr_spinnp_snapdiff_change_rec_V2 ();
extern bool_t xdr_spinnp_snapdiff_change_rec_V2 ();
extern bool_t xdr_SD_NEXT4resok_V1 ();
extern bool_t xdr_SD_NEXT4resok_V2 ();
extern bool_t xdr_SD_NEXT4res ();
extern bool_t xdr_SD_STATUS4args ();
extern bool_t xdr_SD_STATUS4resok ();
extern bool_t xdr_SD_STATUS4res ();
extern bool_t xdr_SD_END4args ();
extern bool_t xdr_SD_END4resok ();
extern bool_t xdr_SD_END4res ();
extern bool_t xdr_SD_DISCONNECT4resok ();
extern bool_t xdr_SD_DISCONNECT4res ();
...
extern bool_t xdr_copy_info4 ();
extern bool_t xdr_CB_COPY4args ();
extern bool_t xdr_CB_COPY4res ();
